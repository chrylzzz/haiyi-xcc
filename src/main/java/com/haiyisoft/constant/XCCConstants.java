...
public class XCCConstants {
    ...
    //欢迎语
    public static final String WELCOME_TEXT = "我是智能语音小助手, 您要咨询什么问题, 您请说";
    //临时欢迎语
    ...
    public static void main(String[] args) {
        System.out.println(WELCOME_TEXT.length());
        System.out.println(WELCOME_TEXT.length() / 32);
        System.out.println(TEST_WELCOME_TEXT.length());
        System.out.println(TEST_WELCOME_TEXT.length() / 10);
    }
